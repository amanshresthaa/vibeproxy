...
final class ResponsesSSEFramerTests: XCTestCase {
    ...
    func testRelayBuffersChunkedJSONResponsesForRewrite() {
        let relay = HTTPResponseRelay(
            requestPath: "/v1/responses",
            jsonBodyTransformer: { body in
                body.replacingOccurrences(of: #""store":false"#, with: #""store":true"#)
            }
        )
